...
public final class FAWE_Spigot_v1_17_R1_2 extends CachedBukkitAdapter implements IDelegateBukkitImplAdapter<NBTBase> {
    ...
    private synchronized boolean init() {
        ...
        for (int i = 0; i < ibdToStateOrdinal.length; i++) {
            ...
            BlockMaterial_1_17_1 material = (BlockMaterial_1_17_1) state.getMaterial();
    ...
    public BlockMaterial getMaterial(BlockType blockType) {
        ...
        return new BlockMaterial_1_17_1(block);
    }

    @Override
    public synchronized BlockMaterial getMaterial(BlockState state) {
        IBlockData bs = ((CraftBlockData) Bukkit.createBlockData(state.getAsString())).getState();
        return new BlockMaterial_1_17_1(bs.getBlock(), bs);
    }
    ...
    public boolean setBlock(org.bukkit.Chunk chunk, int x, int y, int z, BlockStateHolder state, boolean update) {
        ...
        IBlockData blockData = ((BlockMaterial_1_17_1) state.getMaterial()).getState();
        ...
        IBlockData existing;
        if (section == null) {
            existing = ((BlockMaterial_1_17_1) BlockTypes.AIR.getDefaultState().getMaterial()).getState();
        } else {
    ...
    public void sendFakeChunk(org.bukkit.World world, Player player, ChunkPacket packet) {
        ...
        PlayerChunk map = BukkitAdapter_1_17_1.getPlayerChunk(nmsWorld, packet.getChunkX(), packet.getChunkZ());
    ...
    public IChunkGet get(org.bukkit.World world, int chunkX, int chunkZ) {
        return new BukkitGetBlocks_1_17_1(world, chunkX, chunkZ);
    }
