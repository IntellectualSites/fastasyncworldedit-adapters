...
class DataConverters_1_17_R1_2 extends DataFixerBuilder implements com.sk89q.worldedit.world.DataFixer {
    ...
    private CompoundBinaryTag fixChunk(CompoundBinaryTag originalChunk, int srcVer) {
        ...
        NBTTagCompound fixed = convert(DataConverters_1_17_R1_2.LegacyType.CHUNK, tag, srcVer);
    ...
    private CompoundBinaryTag fixBlockEntity(CompoundBinaryTag origTileEnt, int srcVer) {
        ...
        NBTTagCompound fixed = convert(DataConverters_1_17_R1_2.LegacyType.BLOCK_ENTITY, tag, srcVer);
        return (CompoundBinaryTag) adapter.toNativeBinary(fixed);
    }
    ...
    private CompoundBinaryTag fixEntity(CompoundBinaryTag origEnt, int srcVer) {
        ...
        NBTTagCompound fixed = convert(DataConverters_1_17_R1_2.LegacyType.ENTITY, tag, srcVer);
        return (CompoundBinaryTag) adapter.toNativeBinary(fixed);
    }
    ...
    private String fixBlockState(String blockState, int srcVer) {
        ...
        NBTTagCompound fixed = (NBTTagCompound) INSTANCE.fixer
                .update(DataConverterTypes.n, dynamic, srcVer, DATA_VERSION)
                .getValue();
    ...
    static DataConverters_1_17_R1_2 INSTANCE;
    ...
    DataConverters_1_17_R1_2(int dataVersion, Spigot_v1_17_R1_2 adapter) {
        super(dataVersion);
    ...
    private class WrappedDataFixer implements DataFixer {
        ...
        private NBTTagCompound convert(LegacyType type, NBTTagCompound cmp, int sourceVer, int desiredVersion) {
            List<DataConverter> converters = DataConverters_1_17_R1_2.this.converters.get(type);
            ...
            List<DataInspector> inspectors = DataConverters_1_17_R1_2.this.inspectors.get(type);
        ...
        public NBTTagCompound convert(NBTTagCompound cmp) {
            ...
            if (cmp.hasKeyOfType("DropChances", 9)) {
                ...
                if (!cmp.hasKeyOfType("HandDropChances", 10)) {
                    ...
                    nbttaglist2.add(NBTTagFloat.a(nbttaglist1.i(0)));
                ...
                if (!cmp.hasKeyOfType("ArmorDropChances", 10)) {
                    nbttaglist2 = new NBTTagList();
                    nbttaglist2.add(NBTTagFloat.a(nbttaglist1.i(1)));
                    nbttaglist2.add(NBTTagFloat.a(nbttaglist1.i(2)));
                    nbttaglist2.add(NBTTagFloat.a(nbttaglist1.i(3)));
                    nbttaglist2.add(NBTTagFloat.a(nbttaglist1.i(4)));
    ...
    private static class DataInspectorEntity implements DataInspector {
        ...
        private static final Logger a = LogManager.getLogger(DataConverters_1_17_R1_2.class);
    ...
    private static class DataInspectorItemList extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String s : this.keys) {
                DataConverters_1_17_R1_2.convertItems(nbttagcompound, s, sourceVer, targetVer);
            }
    ...
    private static class DataInspectorItem extends DataInspectorTagged {
        ...
        NBTTagCompound inspectChecked(NBTTagCompound nbttagcompound, int sourceVer, int targetVer) {
            for (String key : this.keys) {
                DataConverters_1_17_R1_2.convertItem(nbttagcompound, key, sourceVer, targetVer);
            }
            ...
            IChatMutableComponent a(
                ...
                if (jsonelement.isJsonPrimitive()) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        IChatMutableComponent ichatbasecomponent1 = this.a(
                                jsonelement1,
