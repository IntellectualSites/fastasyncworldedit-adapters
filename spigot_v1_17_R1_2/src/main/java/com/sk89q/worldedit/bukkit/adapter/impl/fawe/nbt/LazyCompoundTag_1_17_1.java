...
public class LazyCompoundTag_1_17_1 extends LazyCompoundTag {

    private final Supplier<NBTTagCompound> nmsTag;
    private CompoundTag cachedValue;

    public LazyCompoundTag_1_17_1(Supplier<NBTTagCompound> tag) {
        super(new HashMap<>());
        this.nmsTag = tag;
    }

    public LazyCompoundTag_1_17_1(NBTTagCompound tag) {
        this(() -> tag);
    }
