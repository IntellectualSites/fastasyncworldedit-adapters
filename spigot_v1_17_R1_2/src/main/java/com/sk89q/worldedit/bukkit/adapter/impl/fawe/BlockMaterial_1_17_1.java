...
public class BlockMaterial_1_17_1 implements BlockMaterial {
    ...
    public BlockMaterial_1_17_1(Block block) {
        this(block, block.getBlockData());
    }

    public BlockMaterial_1_17_1(Block block, IBlockData defaultState) {
        this.block = block;
        ...
        tile = tileEntity == null
                ? null
                : new LazyCompoundTag_1_17_1(Suppliers.memoize(() -> tileEntity.save(new NBTTagCompound())));
    }
