...
public class PostProcessor_1_17 implements IBatchProcessor {
    ...
    public void postProcess(final IChunk chunk, final IChunkGet iChunkGet, final IChunkSet iChunkSet) {
        ...
        BukkitGetBlocks_1_17_Copy getBlocks = (BukkitGetBlocks_1_17_Copy) iChunkGet;
        layer:
    ...
    private void addFluid(final WorldServer worldServer, final BlockState replacedState, final BlockPosition position) {
        ...
        if (replacedState.getBlockType() == BlockTypes.LAVA) {
            type = (int) replacedState.getState(PropertyKey.LEVEL) == 0 ? FluidTypes.e : FluidTypes.d;
        } else {
            type = (int) replacedState.getState(PropertyKey.LEVEL) == 0 ? FluidTypes.c : FluidTypes.b;
        }
        worldServer.getFluidTickList().a(
                position,
                type,
                type.a(worldServer)
        );
