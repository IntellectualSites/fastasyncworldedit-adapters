...
public class BukkitGetBlocks_1_17 extends CharGetBlocks implements BukkitGetBlocks {
    ...
    private static final Function<TileEntity, CompoundTag> nmsTile2We =
            tileEntity -> new LazyCompoundTag_1_17(Suppliers.memoize(() -> tileEntity.save(new NBTTagCompound())));
    ...
    private void updateGet(
            BukkitGetBlocks_1_17 get, Chunk nmsChunk, ChunkSection[] chunkSections, ChunkSection section,
            char[] arr, int layer
    ) {
        synchronized (get) {
                ...
                for (int layer = 0; layer < 16; layer++) {
                    ...
                    synchronized (this) {
                        synchronized (lock) {
                            ...
                            newSection = BukkitAdapter_1_17.newChunkSection(layer, this::loadPrivately, setArr, fastmode);
        ...
        synchronized (lock) {
            ...
            try {
                ...
                final DataPalette<IBlockData> palette =
                        (DataPalette<IBlockData>) BukkitAdapter_1_17.fieldPalette.get(blocks);
        ...
        if (aggressive) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                try {
                    ...
                    final DataPalette<IBlockData> palette =
                            (DataPalette<IBlockData>) BukkitAdapter_1_17.fieldPalette.get(blocksExisting);
                    int paletteSize;
