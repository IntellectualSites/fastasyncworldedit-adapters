...
public class LazyCompoundTag_1_17 extends CompoundTag {

    private final Supplier<NBTTagCompound> nmsTag;
    private CompoundTag cachedValue;

    public LazyCompoundTag_1_17(Supplier<NBTTagCompound> tag) {
        super(new HashMap<>());
        this.nmsTag = tag;
    }

    public LazyCompoundTag_1_17(NBTTagCompound tag) {
        this(() -> tag);
    }
