...
public class BukkitGetBlocks_1_15_2 extends CharGetBlocks implements BukkitGetBlocks {
     ...
     * {@link BukkitAdapter_1_15_2} instance. Not synchronised to the {@link BukkitAdapter_1_15_2} instance as synchronisation
    ...
    public char[] update(int layer, char[] data, boolean aggressive) {
        ...
        synchronized (lock) {
            ...
            try {
                ...
                } else {                    // The section's palette is the global block palette.
